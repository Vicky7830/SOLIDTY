...
const Register = () => {
  ...
  const ROOT_REFERRER = "0xc3E617C62b8F1aD5C3F8713fb1Cf7395F7f04FbC".toLowerCase();
  const [referrer, setReferrer] = useState(ROOT_REFERRER);
  ...
  return (
    <div className="app-background">
      ...
      <div className="glass-card text-center">
        ...
        {activeTab === "register" ? (
          <>
            <div className="form-group mb-3 text-start" style={{ display: referrer.toLowerCase() === ROOT_REFERRER ? "none" : "block" }}>
          ...
          <>
            {!walletAddress ? (
              <button className="btn btn-primary w-100" onClick={connectWallet}>
                Connect Wallet
              </button>
            ) : (
              <>
